...
export class Init1766076306274 implements MigrationInterface {
    name = 'Init1766076306274'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."inbox_messagetype_enum" AS ENUM('createPendingOrder', 'inventoryRemoveResponse', 'shipping_response')`);
