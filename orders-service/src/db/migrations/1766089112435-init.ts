...
export class Init1766089112435 implements MigrationInterface {
    name = 'Init1766089112435'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."inbox_messagetype_enum" AS ENUM('createPendingOrder', 'inventoryResponse', 'shippingResponse')`);
