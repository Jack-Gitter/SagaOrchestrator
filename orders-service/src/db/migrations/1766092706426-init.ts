...
export class Init1766092706426 implements MigrationInterface {
    name = 'Init1766092706426'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."inbox_messagetype_enum" AS ENUM('createPendingOrder', 'inventoryResponse', 'shippingResponse', 'finalizeOrder')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."outbox_messagetype_enum" AS ENUM('removeInventory', 'shipProduct', 'restoreInventory', 'shipProductCancel', 'finalizeOrder')`);
