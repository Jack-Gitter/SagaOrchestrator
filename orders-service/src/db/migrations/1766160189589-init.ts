...
export class Init1766160189589 implements MigrationInterface {
    name = 'Init1766160189589'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."outbox_messagetype_enum" AS ENUM('removeInventoryLocal', 'removeInventory', 'shipOrder', 'restoreInventory', 'shipOrderCancel')`);
